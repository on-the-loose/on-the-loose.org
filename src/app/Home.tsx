  ...
  return (
    <div>
      ...
      <div css={styles.clubDescription}>
        <p>
          Hi! OTL helps students organize trips to destinations across California and the
          Southwestern states.
        </p>
        <p>
